import { copySync } from "https://deno.land/std@0.146.0/fs/mod.ts";

// #region types
// used stuff from https://github.com/ryansolid/dom-expressions/blob/main/packages/dom-expressions/src/jsx.d.ts
...
interface HTMLSlotElementAttributes extends HTMLAttributes {
  name?: string;
}
